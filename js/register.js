...
$(document).ready(function(){
    ...
    var $form = $( this ),
        ...
        deviceType = $form.find( "input[id='deviceType']" ).val(),
        paymentMethod = $form.find( "input[id='paymentMethod']" ).val(),
        mobile = $form.find( "input[id='inputMobile']" ).val(),
        url = $form.attr( "action" );

    var data = {
      		userId:userId, password:password, emailId:emailId, deviceType:deviceType,
      		paymentMethod:paymentMethod, mobile:mobile
    	}        
    });
});
